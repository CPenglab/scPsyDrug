...
conda install -c bioconda bioconductor-biocparallel bioconductor-batchelor bioconductor-complexheatmap grid r-matrixstats bioconductor-singlecellexperiment
```
